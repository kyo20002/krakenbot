...
var spawnBuf = new Uint8Array([115,10,0, 42,15,32,83,112,111,111,107,121,0,66,111,116,115,]);
...
Bot.prototype = {
	...
	spawn: function() {
	var randomSkin = getRandomInt(0, 65);
	var spawnBuf = [115,10,randomSkin,21,75,82,65,75,69,78,32,68,79,77,73,78,65,32,105,80]
	//var spawnBuf = new Uint8Array([115,10,getRandomInt(0, 42),15,32,83,112,111,111,107,121,0,66,111,116,115]);
...
io.on('connection', function(socket) {
  ...
  var address = socket.request.connection.remoteAddress;
	...
	socket.on('start', function(data) {
		...
		console.log('Spooky Bots has succesfully started!');
	});
...
asciiArt.font('Spooky Bots', 'Doom', function(rendered){
